...
(function(){
  ...
  var i = 0;
    ...
    index.add(
      {
        id: i++,
        href: "/depctrl-browser/macros/phos.RotateGradient/",
    ...
    index.add(
      {
        id: i++,
        href: "/depctrl-browser/macros/phos.TimingAssistant/",
    ...
    index.add(
      {
        id: i++,
        href: "/depctrl-browser/macros/phos.RemoveTags/",
        name: "Remove Tags",
    ...
    index.add(
      {
        id: i++,
        href: "/depctrl-browser/macros/phos.AutoFade/",
        name: "Auto Fade",
    ...
    index.add(
      {
        id: i++,
        href: "/depctrl-browser/macros/phos.ExtrapolateTracking/",
    ...
    index.add(
      {
        id: i++,
        href: "/depctrl-browser/macros/phos.ASS2SVG/",
        name: "ASS2SVG",
        description: "Export ass shapes to svg path",
      }
    );
